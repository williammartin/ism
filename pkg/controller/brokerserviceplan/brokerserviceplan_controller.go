...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by BrokerServicePlan - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &osbapiv1alpha1.BrokerServicePlan{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBrokerServicePlan) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the BrokerServicePlan instance
	instance := &osbapiv1alpha1.BrokerServicePlan{}
