...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this servicecatalog.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &servicecatalogv1beta1.ServiceBinding{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by ServiceBinding - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &servicecatalogv1beta1.ServiceBinding{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=servicecatalog.k8s.io,resources=servicebindings,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileServiceBinding) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &servicecatalogv1beta1.ServiceBinding{}
