...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by BrokerService - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &osbapiv1alpha1.BrokerService{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBrokerService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the BrokerService instance
	instance := &osbapiv1alpha1.BrokerService{}
